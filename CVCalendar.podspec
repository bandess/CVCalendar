...
s.homepage     = 'https://github.com/bandess/CVCalendar'
s.screenshot  = 'https://raw.githubusercontent.com/bandess/CVCalendar/master/Screenshots/CVCalendar_White.png'
s.license      = { :type => 'MIT', :file => 'LICENSE' }
s.authors             = { 'Eugene Mozharovsky' => 'mozharovsky@live.com', 'Jonas-Taha El Sesiy' => 'info@elsesiy.com' }
s.platform     = :ios, '8.0'
s.ios.deployment_target = '8.0'
s.source       = { :git => 'https://github.com/bandess/CVCalendar.git', :tag => s.version }
